...
import { Zap, Upload, Download, FileSpreadsheet, CheckCircle2, XCircle, AlertTriangle, MousePointer, ShoppingCart, TrendingUp, Package, ArrowRight } from 'lucide-react';
...
export default function Optimize() {
  ...
  const proceedToChooseReplacements = async () => {
    ...
    // Fetch available products from gudang for this account
    ...
    // Filter out products already in CSV
  ...
  const generateRecommendations = async () => {
    ...
    try {
      ...
      // Save CSV data to product_statistics
      ...
      // Delete used products from gudang
      ...
      <div className="p-6 lg:p-8 space-y-6 animate-fade-in">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Pilih produk yang akan diganti dan pilih pengganti dari gudang</p>
          </div>
          {step !== 'select' && (
